...
/*   Updated: 2025/12/01 16:46:26 by liliu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		draw_wall_pixels(t_game *game, t_ray *ray, int x, t_texture *tex);
...
int			check_no_content_after_map(char **lines, int start, int count);
